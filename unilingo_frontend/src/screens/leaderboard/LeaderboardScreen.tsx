...
const styles = StyleSheet.create({
  ...
  myRankLabel: { fontFamily: 'PlusJakartaSans-Regular', color: '#475569', fontSize: 12 },
  ...
  myStatLabel: { fontFamily: 'PlusJakartaSans-Regular', color: '#475569', fontSize: 10, marginTop: 2 },
